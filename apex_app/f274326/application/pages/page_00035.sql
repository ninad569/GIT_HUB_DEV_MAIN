...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(91684496972915012596)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103867387366181132581)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_list_id=>wwv_flow_imp.id(80575959330928214496)
