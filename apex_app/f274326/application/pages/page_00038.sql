...
,p_alias=>'FORMATTING-VALUES'
,p_step_title=>'Formatting Values'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102639340503054638025)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114822230896320758010)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_list_id=>wwv_flow_imp.id(80578342000126975550)
