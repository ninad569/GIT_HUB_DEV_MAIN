...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(95334533462662100567)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(107517423855928220552)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_list_id=>wwv_flow_imp.id(80575965383222251703)
