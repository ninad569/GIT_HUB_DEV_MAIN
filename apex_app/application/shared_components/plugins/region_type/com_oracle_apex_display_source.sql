...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(78228453847620841369)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(77532288501026824315)
,p_plugin_id=>wwv_flow_imp.id(78228453847620841369)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(77532288897821824315)
,p_plugin_id=>wwv_flow_imp.id(78228453847620841369)
,p_attribute_scope=>'COMPONENT'
