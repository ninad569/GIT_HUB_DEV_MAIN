...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(78444553214511772490)
,p_theme_id=>42
...
,p_default_header_template=>wwv_flow_imp.id(78444520360320772382)
,p_default_footer_template=>wwv_flow_imp.id(78444520360320772382)
