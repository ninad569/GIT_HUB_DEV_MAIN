...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106580243374264790289)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(118763133767530910274)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_list_id=>wwv_flow_imp.id(80866835844568341212)
