...
wwv_flow_imp_page.create_page(
 p_id=>32
,p_name=>'Series Color'
,p_alias=>'SERIES-COLOR'
,p_step_title=>'Series Color'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80734421589667003087)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(92917311982933123072)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_list_id=>wwv_flow_imp.id(80575943691962089041)
