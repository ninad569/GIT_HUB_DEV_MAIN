...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(78503513526610741718)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(87036403626568013396)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_list_id=>wwv_flow_imp.id(77312687803983511221)
