...
,p_alias=>'STACK-GROUPING'
,p_step_title=>'Stack Grouping'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(77438438166928008385)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(85971323331540227559)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_list_id=>wwv_flow_imp.id(77100441502221030586)
